...
function Home() {
  ...
  return (
    <div>
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between px-4 md:px-12 lg:px-24 py-16 gap-10">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="text-lg md:text-xl mt-4 text-gray-600">
            Discover trendsetting products, seamless design, and a fully
            immersive shopping journey crafted just for you.
          </p>
          <button
      ...
      <div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6  flex-row p-2 bg-black  justify-between">
          <div className="flex flex-col-reverse lg:flex-row items-center m-2 p-4 rounded bg-white justify-between gap-4 overflow-hidden">
            ...
            <div>
              <img
                src="https://rukminim2.flixcart.com/image/832/832/xif0q/t-shirt/z/4/w/l-31677849-here-now-original-imahbk8judgjq6hp.jpeg?q=70&crop=false"
                alt="image1"
                className="w-50 h-50 "
              />
            </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center m-2 p-4 rounded bg-white justify-between gap-4 overflow-hidden">
            ...
            <div>
              <img
                src="https://rukminim2.flixcart.com/image/832/832/xif0q/kurta/o/g/h/xl-dp313-saloni-creation-original-imah38hcdghdqvcg.jpeg?q=70&crop=false"
                alt="image2"
                className="w-50 h-50"
              />
            </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center m-2 p-4 rounded bg-white justify-between gap-4 overflow-hidden">
            ...
            <div>
              <img
                src="https://rukminim2.flixcart.com/image/832/832/xif0q/shoe/i/d/w/8-8545-8-killer-sea-green-original-imah7spdwsy3zete.jpeg?q=70&crop=false"
                alt="image3"
                className="w-50 h-50"
              />
            </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center m-2 p-4 rounded bg-white justify-between gap-4 overflow-hidden">
            ...
            <div>
              <img
                src="https://m.media-amazon.com/images/I/61TIYhUzobL.AC_UL480_FMwebp_QL65.jpg"
                alt="image4"
                className="w-50"
              />
            </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center m-2 p-4 rounded bg-white justify-between gap-4 overflow-hidden">
            ...
            <div>
              <img
                src="https://m.media-amazon.com/images/I/81x0yUp0T+L.AC_UL480_FMwebp_QL65.jpg"
                alt="image5"
                className="w-50 h-50"
              />
            </div>
          ...
          <div className="flex flex-col-reverse lg:flex-row items-center m-2 p-4 rounded bg-white justify-between gap-4 overflow-hidden">
            ...
            <div>
              <img
                src="https://m.media-amazon.com/images/I/81xyPfQrT1L.AC_UL480_FMwebp_QL65.jpg"
                alt="image6"
                className="w-50 h-50"
              />
            </div>
